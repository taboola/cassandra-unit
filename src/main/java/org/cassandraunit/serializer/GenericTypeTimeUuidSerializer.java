...
import static org.cassandraunit.type.GenericTypeEnum.TIME_UUID_TYPE;

public class GenericTypeTimeUuidSerializer extends AbstractSerializer<GenericType> {
    @Override
    ...
    public GenericType fromByteBuffer(ByteBuffer byteBuffer) {
        ...
        return new GenericType(value.toString(), TIME_UUID_TYPE);
    }
}
